...
const menuData = {
    ...
    sandwiches: { title: 'Sandwiches & Panini', description: 'Knusprig, frisch und mit Premium-Zutaten gefüllt', items: [{ name: 'Platzhalter Sandwich 1', price: '0,00', description: 'Hier kommt bald eine Beschreibung hin' }] },
